...
setInterval(function () {
    console.info('\n\nMining HeroooesCoin - awaiting to resolve block.');
    try {
        ...
        setTimeout(function () {
            ...
            try {
                if (fs.existsSync(path)) {
                    var objBlock;
                    var obj = JSON.parse(fs.readFileSync('wallet.dat', 'utf8'));
                    var cryptoAssetInput = { PrivateKey: obj.PrivateKey, PublicKey: obj.PublicKey, CryptoAsset: "HeroooesCoin", BlockRequest: blocktodownload };
